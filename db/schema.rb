...
ActiveRecord::Schema.define(version: 2021_01_19_171119) do
  ...
  create_table "spree_addresses", id: :integer, force: :cascade do |t|
    t.string "firstname"
    t.string "lastname"
    t.string "address1"
    t.string "address2"
  ...
  create_table "spree_adjustments", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_assets", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_calculators", id: :integer, force: :cascade do |t|
    t.string "type"
  ...
  create_table "spree_countries", id: :integer, force: :cascade do |t|
    t.string "iso_name"
  ...
  create_table "spree_credit_cards", id: :integer, force: :cascade do |t|
    t.string "month"
    t.string "year"
    t.string "cc_type"
    t.string "last_digits"
  ...
  create_table "spree_customer_returns", id: :integer, force: :cascade do |t|
    t.string "number"
  ...
  create_table "spree_gateways", id: :integer, force: :cascade do |t|
    t.string "type"
    t.string "name"
    t.text "description"
  ...
  create_table "spree_inventory_units", id: :integer, force: :cascade do |t|
    t.string "state"
  ...
  create_table "spree_line_items", id: :integer, force: :cascade do |t|
    t.integer "variant_id"
    t.integer "order_id"
  ...
  create_table "spree_log_entries", id: :integer, force: :cascade do |t|
    t.string "source_type"
    t.integer "source_id"
    t.text "details"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_option_type_prototypes", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_option_types", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_option_value_variants", id: :integer, force: :cascade do |t|
    t.integer "variant_id"
  ...
  create_table "spree_option_values", id: :integer, force: :cascade do |t|
    t.integer "position"
    t.string "name"
  ...
  create_table "spree_order_promotions", id: :integer, force: :cascade do |t|
    t.integer "order_id"
  ...
  create_table "spree_orders", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_payment_capture_events", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_payment_methods", id: :integer, force: :cascade do |t|
    t.string "type"
    t.string "name"
    t.text "description"
    t.boolean "active", default: true
  ...
  create_table "spree_payments", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_preferences", id: :integer, force: :cascade do |t|
    t.text "value"
    t.string "key"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "spree_prices", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_product_option_types", id: :integer, force: :cascade do |t|
    t.integer "position"
  ...
  create_table "spree_product_promotion_rules", id: :integer, force: :cascade do |t|
    t.integer "product_id"
  ...
  create_table "spree_product_properties", id: :integer, force: :cascade do |t|
    t.string "value"
    t.integer "product_id"
  ...
  create_table "spree_products", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_products_taxons", id: :integer, force: :cascade do |t|
    t.integer "product_id"
    t.integer "taxon_id"
    t.integer "position"
  ...
  create_table "spree_promotion_action_line_items", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_promotion_actions", id: :integer, force: :cascade do |t|
    t.integer "promotion_id"
    t.integer "position"
    t.string "type"
    t.datetime "deleted_at"
  ...
  create_table "spree_promotion_categories", id: :integer, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "code"
  ...
  create_table "spree_promotion_rule_taxons", id: :integer, force: :cascade do |t|
    t.integer "taxon_id"
    t.integer "promotion_rule_id"
  ...
  create_table "spree_promotion_rule_users", id: :integer, force: :cascade do |t|
    t.integer "user_id"
    t.integer "promotion_rule_id"
  ...
  create_table "spree_promotion_rules", id: :integer, force: :cascade do |t|
    t.integer "promotion_id"
    t.integer "user_id"
  ...
  create_table "spree_promotions", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_properties", id: :integer, force: :cascade do |t|
    t.string "name"
  ...
  create_table "spree_property_prototypes", id: :integer, force: :cascade do |t|
    t.integer "prototype_id"
    t.integer "property_id"
  ...
  create_table "spree_prototype_taxons", id: :integer, force: :cascade do |t|
    t.integer "taxon_id"
    t.integer "prototype_id"
  ...
  create_table "spree_prototypes", id: :integer, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "spree_refund_reasons", id: :integer, force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
  ...
  create_table "spree_refunds", id: :integer, force: :cascade do |t|
    t.integer "payment_id"
    t.decimal "amount", precision: 10, scale: 2, default: 0.0, null: false
  ...
  create_table "spree_reimbursement_credits", id: :integer, force: :cascade do |t|
    t.decimal "amount", precision: 10, scale: 2, default: 0.0, null: false
    t.integer "reimbursement_id"
  ...
  create_table "spree_reimbursement_types", id: :integer, force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.boolean "mutable", default: true
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_reimbursements", id: :integer, force: :cascade do |t|
    t.string "number"
  ...
  create_table "spree_return_authorization_reasons", id: :integer, force: :cascade do |t|
    t.string "name"
    t.boolean "active", default: true
    t.boolean "mutable", default: true
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_return_authorizations", id: :integer, force: :cascade do |t|
    t.string "number"
    t.string "state"
    t.integer "order_id"
    t.text "memo"
  ...
  create_table "spree_return_items", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_role_users", id: :integer, force: :cascade do |t|
    t.integer "role_id"
    t.integer "user_id"
  ...
  create_table "spree_roles", id: :integer, force: :cascade do |t|
    t.string "name"
    t.index ["name"], name: "index_spree_roles_on_name", unique: true
  end

  create_table "spree_shipments", id: :integer, force: :cascade do |t|
    t.string "tracking"
    t.string "number"
  ...
  create_table "spree_shipping_categories", id: :integer, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "spree_shipping_method_categories", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_shipping_method_zones", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_shipping_methods", id: :integer, force: :cascade do |t|
    t.string "name"
    t.string "display_on"
    t.datetime "deleted_at"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_shipping_rates", id: :integer, force: :cascade do |t|
    t.integer "shipment_id"
    t.integer "shipping_method_id"
  ...
  create_table "spree_state_changes", id: :integer, force: :cascade do |t|
    t.string "name"
  ...
  create_table "spree_states", id: :integer, force: :cascade do |t|
    t.string "name"
    t.string "abbr"
    t.integer "country_id"
    t.datetime "updated_at"
  ...
  create_table "spree_stock_items", id: :integer, force: :cascade do |t|
    t.integer "stock_location_id"
    t.integer "variant_id"
  ...
  create_table "spree_stock_locations", id: :integer, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "default", default: false, null: false
  ...
  create_table "spree_stock_movements", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_stock_transfers", id: :integer, force: :cascade do |t|
    t.string "type"
    t.string "reference"
  ...
  create_table "spree_store_credit_categories", id: :integer, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "spree_store_credit_events", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_store_credit_types", id: :integer, force: :cascade do |t|
    t.string "name"
    t.integer "priority"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "spree_store_credits", id: :integer, force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "spree_stores", id: :integer, force: :cascade do |t|
    t.string "name"
    t.string "url"
    t.text "meta_description"
  ...
  create_table "spree_tax_categories", id: :integer, force: :cascade do |t|
    t.string "name"
    t.string "description"
  ...
  create_table "spree_tax_rates", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_taxonomies", id: :integer, force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "position", default: 0
  ...
  create_table "spree_taxons", id: :integer, force: :cascade do |t|
    t.integer "parent_id"
    t.integer "position", default: 0
    t.string "name", null: false
    t.string "permalink"
  ...
  create_table "spree_trackers", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_users", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_variants", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_zone_members", id: :integer, force: :cascade do |t|
  ...
  create_table "spree_zones", id: :integer, force: :cascade do |t|
    t.string "name"
    t.string "description"
