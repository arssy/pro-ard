...
class SpreeOneTwo < ActiveRecord::Migration[4.2]
  def up
    ...
    create_table :spree_option_types_prototypes do |t|
    ...
    create_table :spree_option_values_variants do |t|
      t.references :variant
    ...
    create_table :spree_products_taxons do |t|
      t.references :product
      t.references :taxon
    end
    ...
    create_table :spree_properties_prototypes do |t|
      t.references :prototype
      t.references :property
    end
